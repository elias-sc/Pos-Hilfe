function getCodeOutput(code){
    return fetch('http://localhost:3000/execute-code', {
        method: 'POST',
        headers: {
...
function getExercise(id) {
    return fetch('http://localhost:3000/get-exercise', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
function getAmountOfExercises(){
    return fetch('http://localhost:3000/get-exercise-amount', {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
        },
...
function getTests(exercise_id) {
    return fetch('http://localhost:3000/get-tests', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
async function markExerciseCompleted(exerciseId) {
    ...
    fetch('http://localhost:3000/store-completed-exercise', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
function getCompletedExercises(){
    ...
    return fetch('http://localhost:3000/get-completed-exercises', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
